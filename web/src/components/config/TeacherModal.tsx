...
export function TeacherModal({ teacher, classes, onSave, onRemove, onClose }: Props) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg overflow-hidden rounded-xl shadow-2xl" style={{ backgroundColor: 'var(--surface)' }}>
        <div
        ...
        >
          ...
          <button
            onClick={onClose}
            className="text-lg leading-none text-white/60 hover:text-white transition-colors"
          >
            ✕
          </button>
        </div>
